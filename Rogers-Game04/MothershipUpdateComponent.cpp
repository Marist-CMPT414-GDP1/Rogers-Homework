...
void MothershipUpdateComponent::update(float fps)
{
	...
	// Is the middle of the Mothership above the player +- 1 world units
	...
	{
		// Has the Mothership waited long enough since the last shot
...
void MothershipUpdateComponent::dropDownAndReverse()
{
